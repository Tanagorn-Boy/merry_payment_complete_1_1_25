...
function PaymentMembership() {
  ...
  useEffect(() => {
    console.log("userId is:", userId); // ตรวจสอบว่า userId มีค่า
    if (userId) {
      fetchMembership();
      fetchPaymentHistory();
    }
  ...
  console.log("paymentMembership is : ", paymentMembership);
          ...
          <div className="relative mt-4 rounded-[24px] bg-bg-card p-6 text-white">
            <div className="flex flex-col gap-4">
              <div className="h-[50px] w-[50px] flex-shrink-0">
                <img src={paymentMembership.icon_url} alt="Package Icon" />
              </div>
              <div>
            ...
            <div className="mt-6 flex flex-col justify-between text-sm lg:hidden lg:text-base">
              <div className="flex justify-between">
                ...
                <p className="font-semibold">01/04/2022</p>
              </div>
              <div className="flex justify-between">
                <p>Next billing</p>
                <p className="font-semibold">01/05/2022</p>
              </div>
            </div>
